...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1855: x0 => x0.parent,
      _1856: x0 => x0.BarcodeDetector,
      _1857: x0 => x0.navigator,
      _1858: x0 => x0.navigator,
      _1860: x0 => x0.document,
      _1861: x0 => x0.document,
      _1862: x0 => x0.location,
      _1865: x0 => x0.focus(),
      _1872: x0 => x0.href,
      _1874: x0 => x0.hostname,
      _1877: x0 => x0.search,
      _1879: (x0,x1) => x0.createElement(x1),
      _1880: x0 => x0.body,
      _1882: x0 => x0.hasFocus(),
      _1884: (x0,x1) => x0.appendChild(x1),
      _1885: x0 => x0.click(),
      _1886: (x0,x1) => x0.removeChild(x1),
      _1887: x0 => globalThis.URL.createObjectURL(x0),
      _1888: (x0,x1) => x0.item(x1),
      _1889: (module,f) => finalizeWrapper(f, function() { return module.exports._1889(f,arguments.length) }),
      _1890: (module,f) => finalizeWrapper(f, function() { return module.exports._1890(f,arguments.length) }),
      _1891: (module,f) => finalizeWrapper(f, function() { return module.exports._1891(f,arguments.length) }),
      _1893: (x0,x1) => x0.writeText(x1),
      _1894: x0 => x0.readText(),
      _1896: x0 => x0.mediaDevices,
      _1898: x0 => x0.onLine,
      _1899: x0 => x0.credentials,
      _1900: (x0,x1,x2,x3,x4) => x0.share(x1,x2,x3,x4),
      _1901: x0 => x0.clipboard,
      _1903: (x0,x1) => x0.getUserMedia(x1),
      _1904: (x0,x1) => x0.detect(x1),
      _1908: x0 => x0.rawValue,
      _1916: x0 => x0.name,
      _1918: x0 => x0.arrayBuffer(),
      _1919: x0 => x0.text(),
      _1921: x0 => x0.length,
      _1927: x0 => x0.done,
      _1928: x0 => x0.value,
      ...
      _1932: x0 => x0.body,
      _1933: x0 => x0.text(),
      _1936: (x0,x1) => { x0.onerror = x1 },
      _1937: (x0,x1) => { x0.onmessage = x1 },
      _1959: x0 => x0.data,
      _1960: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1961: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1963: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1963(f,arguments.length,x0) }),
      _1987: x0 => x0.message,
      _1988: x0 => x0.signal,
      _1989: x0 => x0.aborted,
      _1998: x0 => x0.close,
      _2002: (x0,x1) => ({type: x0,alg: x1}),
      _2003: (x0,x1) => ({id: x0,name: x1}),
      _2004: (x0,x1,x2) => ({id: x0,displayName: x1,name: x2}),
      _2005: x0 => x0.id,
      _2006: x0 => x0.type,
      _2007: () => globalThis.PublicKeyCredential.isUserVerifyingPlatformAuthenticatorAvailable(),
      _2010: x0 => x0.response,
      _2012: x0 => x0.clientDataJSON,
      _2013: x0 => x0.authenticatorData,
      _2014: x0 => x0.signature,
      _2018: x0 => x0.getPublicKeyAlgorithm(),
      _2020: (x0,x1) => x0.create(x1),
      _2021: (x0,x1) => x0.get(x1),
      _2022: x0 => ({authenticatorAttachment: x0}),
      _2023: (x0,x1,x2,x3,x4) => ({authenticatorSelection: x0,challenge: x1,pubKeyCredParams: x2,rp: x3,user: x4}),
      _2024: x0 => ({publicKey: x0}),
      _2025: (x0,x1) => ({id: x0,type: x1}),
      _2026: (x0,x1,x2) => ({challenge: x0,allowCredentials: x1,userVerification: x2}),
      _2027: (x0,x1) => ({publicKey: x0,mediation: x1}),
      _2036: x0 => x0.id,
      _2037: (x0,x1) => { x0.id = x1 },
      _2042: (x0,x1) => { x0.autoplay = x1 },
      _2047: (x0,x1) => { x0.href = x1 },
      _2048: (x0,x1) => { x0.target = x1 },
      _2049: (x0,x1) => { x0.download = x1 },
      _2052: (x0,x1) => { x0.srcObject = x1 },
      _2061: (x0,x1) => { x0.accept = x1 },
      _2063: (x0,x1) => { x0.type = x1 },
      _2064: (x0,x1) => { x0.onchange = x1 },
      _2065: (x0,x1) => { x0.onerror = x1 },
      _2066: (x0,x1) => { x0.oncancel = x1 },
      _2067: x0 => x0.files,
      _2068: (x0,x1) => new WebSocket(x0,x1),
      _2069: x0 => x0.readyState,
      _2071: (x0,x1) => x0.send(x1),
      _2073: (x0,x1) => { x0.onclose = x1 },
      _2074: (x0,x1) => { x0.onmessage = x1 },
      _2075: (x0,x1) => { x0.onopen = x1 },
      _2076: x0 => x0.code,
      _2077: x0 => x0.reason,
      _2079: x0 => x0.data,
      _2080: x0 => x0.storage,
      ...
      _2082: x0 => x0.runtime,
      _2084: x0 => x0.windows,
      _2085: x0 => x0.sidePanel,
      _2086: x0 => x0.sidePanel,
      _2088: x0 => x0.sidebarAction,
      _2089: x0 => x0.sidebarAction,
      _2090: x0 => x0.runtime,
      _2093: () => globalThis.chrome,
      _2094: () => globalThis.chrome,
      _2095: () => globalThis.browser,
      _2096: () => globalThis.browser,
      _2097: () => globalThis.opr,
      ...
      _2380: x0 => x0.close(),
      _2382: x0 => x0.open,
      _2383: (x0,x1) => x0.open(x1),
      _2387: (x0,x1) => ({tabId: x0,windowId: x1}),
      _2403: x0 => x0.stop(),
