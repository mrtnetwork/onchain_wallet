...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _194: (x0,x1,x2,x3,x4,x5) => ({worker_message_message: x0,worker_message_buffer: x1,worker_message_port: x2,worker_config: x3,worker_message_type: x4,worker_message_id: x5}),
      _195: (x0,x1) => ({transfableParams: x0,message: x1}),
      _198: (x0,x1,x2) => ({worker_message_buffer: x0,worker_message_type: x1,worker_message_id: x2}),
      _199: x0 => x0.worker_message_type,
      _200: x0 => x0.worker_message_id,
      _202: x0 => x0.worker_message_message,
      _203: x0 => x0.worker_message_buffer,
      _204: x0 => x0.worker_message_port,
      _205: x0 => x0.worker_config,
      _245: x0 => x0.arrayBuffer(),
      _246: () => new AbortController(),
      _247: x0 => x0.getReader(),
      _248: x0 => x0.cancel(),
      _249: x0 => x0.abort(),
      _250: x0 => x0.read(),
      _251: x0 => x0.releaseLock(),
      _252: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._252(f,arguments.length,x0,x1,x2) }),
      _253: (x0,x1) => x0.forEach(x1),
      _254: (module,f) => finalizeWrapper(f, function() { return module.exports._254(f,arguments.length) }),
      _255: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._255(f,arguments.length,x0) }),
      _256: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._256(f,arguments.length,x0) }),
      _257: (x0,x1,x2) => x0.close(x1,x2),
      _258: () => new Headers(),
      _259: (x0,x1,x2) => x0.append(x1,x2),
      _260: (x0,x1,x2,x3) => ({method: x0,headers: x1,body: x2,signal: x3}),
      _261: (x0,x1,x2) => x0.fetch(x1,x2),
      _262: (x0,x1) => globalThis.fetch(x0,x1),
      _264: () => globalThis.window,
      _550: x0 => x0.name,
      _561: x0 => x0.done,
      _562: x0 => x0.value,
      _564: x0 => x0.status,
