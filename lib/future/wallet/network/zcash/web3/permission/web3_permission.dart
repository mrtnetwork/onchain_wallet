...
class ZcashWeb3PermissionView extends StatefulWidget {
  const ZcashWeb3PermissionView({required this.application, super.key});
  final Web3ApplicationAuthentication application;

  @override
  State<ZcashWeb3PermissionView> createState() => _ZcashWeb3PermissionViewState();
}

class _ZcashWeb3PermissionViewState extends State<ZcashWeb3PermissionView>
    with
        SafeState,
        Web3PermissionState<
            ZcashWeb3PermissionView,
            ZcashAddress,
            ZcashChain,
            IZcashAddress,
        ...
        Web3DefaultPermissionState<IZcashAddress> {
  @override
  ...
  Widget build(BuildContext context) {
    return UpdateChainPermissionWidget<ZcashAddress, IZcashAddress, ZcashChain>(
        chain: chain,
