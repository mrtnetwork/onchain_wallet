...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _161: x0 => x0.start(),
      _162: x0 => { globalThis.init_script = x0 },
      _163: x0 => { globalThis.onscriptmessage = x0 },
      _164: x0 => { globalThis.close_script = x0 },
      _165: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._165(f,arguments.length,x0) }),
      _167: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._167(f,arguments.length,x0) }),
      _168: (module,f) => finalizeWrapper(f, function() { return module.exports._168(f,arguments.length) }),
      _170: (x0,x1,x2) => x0.postMessage(x1,x2),
      _195: (x0,x1,x2,x3,x4,x5) => ({worker_message_message: x0,worker_message_buffer: x1,worker_message_port: x2,worker_config: x3,worker_message_type: x4,worker_message_id: x5}),
      _196: (x0,x1) => ({transfableParams: x0,message: x1}),
      _199: (x0,x1,x2) => ({worker_message_buffer: x0,worker_message_type: x1,worker_message_id: x2}),
      _200: x0 => x0.worker_message_type,
      _201: x0 => x0.worker_message_id,
      _203: x0 => x0.worker_message_message,
      _204: x0 => x0.worker_message_buffer,
      _205: x0 => x0.worker_message_port,
      _206: x0 => x0.worker_config,
      _246: x0 => x0.arrayBuffer(),
      _247: () => new AbortController(),
      _248: x0 => x0.getReader(),
      _249: x0 => x0.cancel(),
      _250: x0 => x0.abort(),
      _251: x0 => x0.read(),
      _252: x0 => x0.releaseLock(),
      _253: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._253(f,arguments.length,x0,x1,x2) }),
      _254: (x0,x1) => x0.forEach(x1),
      _255: (module,f) => finalizeWrapper(f, function() { return module.exports._255(f,arguments.length) }),
      ...
      _258: (x0,x1,x2) => x0.close(x1,x2),
      _259: () => new Headers(),
      _260: (x0,x1,x2) => x0.append(x1,x2),
      _261: (x0,x1,x2,x3) => ({method: x0,headers: x1,body: x2,signal: x3}),
      _262: (x0,x1,x2) => x0.fetch(x1,x2),
      _263: (x0,x1) => globalThis.fetch(x0,x1),
      _265: () => globalThis.window,
      _551: x0 => x0.name,
      _562: x0 => x0.done,
      _563: x0 => x0.value,
      _565: x0 => x0.status,
      ...
      _910: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
