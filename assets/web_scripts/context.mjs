...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _170: (x0,x1,x2) => x0.postMessage(x1,x2),
      _195: x0 => ({type: x0}),
      _196: (x0,x1,x2) => new File(x0,x1,x2),
      _197: (x0,x1,x2,x3,x4,x5) => ({worker_message_message: x0,worker_message_buffer: x1,worker_message_port: x2,worker_config: x3,worker_message_type: x4,worker_message_id: x5}),
      _198: (x0,x1) => ({transfableParams: x0,message: x1}),
      _201: (x0,x1,x2) => ({worker_message_buffer: x0,worker_message_type: x1,worker_message_id: x2}),
      _202: x0 => x0.worker_message_type,
      _203: x0 => x0.worker_message_id,
      _205: x0 => x0.worker_message_message,
      _206: x0 => x0.worker_message_buffer,
      _207: x0 => x0.worker_message_port,
      _208: x0 => x0.worker_config,
      _248: x0 => x0.arrayBuffer(),
      _249: () => new AbortController(),
      _250: x0 => x0.getReader(),
      _251: x0 => x0.cancel(),
      _252: x0 => x0.abort(),
      _253: x0 => x0.read(),
      _254: x0 => x0.releaseLock(),
      _255: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._255(f,arguments.length,x0,x1,x2) }),
      _256: (x0,x1) => x0.forEach(x1),
      _257: (module,f) => finalizeWrapper(f, function() { return module.exports._257(f,arguments.length) }),
      _258: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._258(f,arguments.length,x0) }),
      _259: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._259(f,arguments.length,x0) }),
      _260: (x0,x1,x2) => x0.close(x1,x2),
      _261: () => new Headers(),
      _262: (x0,x1,x2) => x0.append(x1,x2),
      _263: (x0,x1,x2,x3) => ({method: x0,headers: x1,body: x2,signal: x3}),
      _264: (x0,x1,x2) => x0.fetch(x1,x2),
      _265: (x0,x1) => globalThis.fetch(x0,x1),
      _267: () => globalThis.window,
      _278: (x0,x1) => x0.put(x1),
      _279: (x0,x1,x2) => x0.transaction(x1,x2),
      _280: (x0,x1) => x0.objectStore(x1),
      _281: (x0,x1) => x0.open(x1),
      _283: (x0,x1) => ({keyPath: x0,autoIncrement: x1}),
      _284: (x0,x1,x2) => x0.createObjectStore(x1,x2),
      _288: x0 => x0.close(),
      _294: (x0,x1) => x0.index(x1),
      _295: (x0,x1) => x0.get(x1),
      _296: (x0,x1) => x0.delete(x1),
      _297: x0 => globalThis.IDBKeyRange.only(x0),
      _298: (x0,x1,x2) => x0.openCursor(x1,x2),
      _299: (x0,x1,x2) => x0.openCursor(x1,x2),
      _300: (module,f) => finalizeWrapper(f, function() { return module.exports._300(f,arguments.length) }),
      _301: (x0,x1) => x0.advance(x1),
      _302: x0 => x0.continue(),
      _303: x0 => x0.delete(),
      _304: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._304(f,arguments.length,x0) }),
      _305: (x0,x1) => x0.add(x1),
      _306: x0 => ({unique: x0}),
      _307: (x0,x1,x2,x3) => x0.createIndex(x1,x2,x3),
      _308: x0 => x0.id,
      _310: x0 => x0.storage,
      _311: (x0,x1) => { x0.storage = x1 },
      _312: x0 => x0.storage_id,
      _313: (x0,x1) => { x0.storage_id = x1 },
      _314: x0 => x0.key,
      _315: (x0,x1) => { x0.key = x1 },
      _316: x0 => x0.key_a,
      _317: (x0,x1) => { x0.key_a = x1 },
      _318: x0 => x0.data,
      _319: (x0,x1) => { x0.data = x1 },
      _320: x0 => x0.createdAt,
      _321: (x0,x1) => { x0.createdAt = x1 },
      _322: x0 => x0.updateAt,
      _323: (x0,x1) => { x0.updateAt = x1 },
      _324: (x0,x1,x2) => x0.open(x1,x2),
      _325: (x0,x1) => x0.deleteObjectStore(x1),
      ...
      _624: x0 => x0.signal,
      _625: x0 => x0.aborted,
      _628: (x0,x1) => { x0.onmessage = x1 },
      _630: x0 => x0.port1,
      _631: x0 => x0.port2,
      _632: x0 => x0.close,
      _702: (x0,x1) => new WebSocket(x0,x1),
      _703: x0 => x0.readyState,
      _705: (x0,x1) => x0.send(x1),
      _707: (x0,x1) => { x0.onclose = x1 },
      _708: (x0,x1) => { x0.onmessage = x1 },
      _709: (x0,x1) => { x0.onopen = x1 },
      _710: x0 => x0.code,
      _711: x0 => x0.reason,
      _713: x0 => x0.data,
